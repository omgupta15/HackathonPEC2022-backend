...
var schema = Joi.object({
  ...
  workerTagRequired: (_Joi$string = Joi.string()).valid.apply(_Joi$string, _toConsumableArray(config.WORKER_TAGS)).required()
});

module.exports = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var formData, validationResponse, newJob;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            validationResponse = _context.sent;
            _context.next = 11;
            break;
          ...
          case 7:
            ...
            console.log("[jobs/employer/create]", "formData validation error:", _context.t0);
          ...
          case 11:
            ...
            console.log("[jobs/employer/create]", "formData validation error:", validationResponse);
            return _context.abrupt("return", res.status(400).json({
              success: true,
              error: "invalid-data"
            }));
          ...
          case 14:
            newJob = new Job(_objectSpread(_objectSpread({}, validationResponse.value), {}, {
